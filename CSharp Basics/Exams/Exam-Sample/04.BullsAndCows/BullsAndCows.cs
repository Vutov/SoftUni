...
class BullsAndCows
{
    ...
    {
        int secred = int.Parse(Console.ReadLine());
        int neededBulls = int.Parse(Console.ReadLine());
        int neededCows = int.Parse(Console.ReadLine());
        ...
        for (int d1 = 1; d1 <= 9; d1++)
        {
            for (int d2 = 1; d2 <= 9; d2++)
            {
                for (int d3 = 1; d3 <= 9; d3++)
                {
                    ...
                    {
                        int guess1 = (secred / 1000) % 10;
                        int guess2 = (secred / 100) % 10;
                        int guess3 = (secred / 10) % 10;
                        int guess4 = (secred / 1) % 10;
                        ...
                        if (bulls == neededBulls && cows == neededCows)
                        {
                            if (solutionFound)
                            {
                                Console.Write(" ");
