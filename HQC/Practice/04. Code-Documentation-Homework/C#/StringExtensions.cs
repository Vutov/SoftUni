...
public static class StringExtensions
{
    ...
    /// <summary>
    /// Converts given string to ushort if possible.
    /// </summary>
    /// <param name="input">string</param>
    /// <returns>ushort version of the string or 0</returns>
    ...
    /// <summary>
    /// Converts given string to int if possible.
    /// </summary>
    /// <param name="input">string</param>
    /// <returns>int version of the string or 0</returns>
    ...
    /// <param name="startFrom">int start point</param>
