...
namespace ConsoleForum
{
    public static class Messages
    {
        ...
        public const string Header = "[ {0} ID: {1} ]";
        public const string Author = "Posted by: {0}";
        public const string Title = "{0} Title: {1}";
        public const string Body = "{0} Body: {1}";
        public const string NoAnswers = "No answers";
        public const string Answers = "Answers:";

        public static string EquelsSeparator = new string('=', 20);
        public static string StarsSeparator = new string('*', 20);
        public static string DashesSeparator = new string('-', 20);
        public static string WavesSeparator = new string('~', 20);
    }
}
